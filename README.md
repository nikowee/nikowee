...
## 📊 Recent Engineering Endeavors
* 🧠 **LoRA-Injection-Detector:** Fine-tuning an 8B Llama model on adversarial partitions and compiling it down to a 4-bit CPU GGUF microservice container.
* 🏥 **Agentic AI in Healthcare (Research):** Co-leading the evaluation framework for a coordinated multi-agent architecture in medical conversation contexts.
